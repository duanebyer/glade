#ifndef __GLADE_ORTHTREE_VALUE_H_
#define __GLADE_ORTHTREE_VALUE_H_
...
template<
	...
	typename NodeValue,
	typename Details>
struct Orthtree<Dim, Vector, LeafValue, NodeValue, Details>::Leaf final {
...
template<
	...
	typename Details>
template<bool Const>
struct Orthtree<Dim, Vector, LeafValue, NodeValue, Details>::NodeBase final {
